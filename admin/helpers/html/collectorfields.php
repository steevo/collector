 ...
 * @package		Collector
 */
abstract class JHtmlCollectorFields
{
	/**
	...
	static function home($value = 0, $i, $canChange = true)
	{
		...
		$states	= array(
			0	=> array('unfeatured',	'fields.home',		'COM_COLLECTOR_UNHOME',	'COM_COLLECTOR_TOGGLE_TO_HOME'),
			1	=> array('featured',	'fields.unhome',	'COM_COLLECTOR_HOME',	'COM_COLLECTOR_FIELD_HOME'),
		);
